...
private:
  int j; // Imaginary component j
  int k; // Imaginary component k
...
public:
   ...
   *         The result is a quaternion with the summed real and imaginary
   * parts. If the other object is not a Quaternion, an error message is
   ...
   *
   * This method performs quaternion multiplication based on the following
   * formula:
   *
   ...
   * @return A new Quaternion that represents the product of the two
   * quaternions. If the other object is not a Quaternion, an error message is
   * printed, and nullptr is returned.
   */
